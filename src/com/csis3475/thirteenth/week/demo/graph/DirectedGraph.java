...
import com.csis3475.thirteenth.week.demo.graph.Vertex.Edge;
...
public class DirectedGraph<T> implements GraphInterface<T>
{
   ...
   public void changeWeight(T begin, T end, double newEdgeWeight) {
	   
	   VertexInterface<T> originVertex = vertices.getValue(begin);
	   VertexInterface<T> endVertex = vertices.getValue(end);
	   
	   if(hasEdge(begin, end) == true)
		   originVertex.connect(endVertex, newEdgeWeight);
	   	      
	   System.out.println("--------------------------------------------------");
	   System.out.println("The weight of the edge " + newEdgeWeight);
	   System.out.println("--------------------------------------------------");
