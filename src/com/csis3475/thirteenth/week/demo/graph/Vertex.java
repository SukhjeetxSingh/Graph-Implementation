package com.csis3475.thirteenth.week.demo.graph;
import com.csis3475.thirteenth.week.demo.graph.driver.GraphUtility;
...
class Vertex<T> implements VertexInterface<T>
{
   ...
   /*
    * updated and different function to edit edge of a vertex
    */
   public boolean connect(VertexInterface<T> endVertex, double edgeWeight)
   {
      ...
      /*
       * skip all in between values of changeweight if any or// 
       * 		skip duplicate edges and change in the existing one
       */
	    ...
	    if (!duplicateEdge)
	    {
	       ...
	       result = true;
	    	...
	    	/*
	    	 * Main logic to change the weight
	    	 */
	   	 edgeList.getIterator().next().weight = edgeWeight;
	        result = true;
	    }      
      return result;
   } // end connect
